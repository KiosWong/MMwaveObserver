...
protected:
  ...
  void drawLinePlot(QCPPainter *painter, const QVector<QPointF> &lineData) const;
...
//                QVector<QPointF> lineData(QVector<QPointF>((points.constBegin() + segmentStart), (points.constBegin() + i - segmentStart)));
        ...
        for(int i = segmentStart; i < points.size(); i++)
            lineData.append(points.at(i));
